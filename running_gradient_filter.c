...
#endif
#include <math.h>
#define __PYX_HAVE__running_gradient_filter
#define __PYX_HAVE_API__running_gradient_filter
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
struct __pyx_opt_args_23running_gradient_filter_running_gradient_3D;

/* "running_gradient_filter.pyx":40
 * #############################################################################
 * 
 * cpdef numpy.ndarray[float, ndim=3] running_gradient_3D(numpy.ndarray[float, ndim=3] data,             # <<<<<<<<<<<<<<
 *                                                        int period, float mv=2e20):
 *     cdef int W = period/2           # window width
 */
struct __pyx_opt_args_23running_gradient_filter_running_gradient_3D {
  int __pyx_n;
  float mv;
...
/* Module declarations from 'running_gradient_filter' */
static void __pyx_f_23running_gradient_filter_calc_a_b(float, float, float, float, int, float *, float *); /*proto*/
static PyArrayObject *__pyx_f_23running_gradient_filter_running_gradient_3D(PyArrayObject *, int, int __pyx_skip_dispatch, struct __pyx_opt_args_23running_gradient_filter_running_gradient_3D *__pyx_optional_args); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_float = { "float", NULL, sizeof(float), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "running_gradient_filter"
int __pyx_module_is_main_running_gradient_filter = 0;

/* Implementation of 'running_gradient_filter' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_23running_gradient_filter_running_gradient_3D(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, int __pyx_v_period, float __pyx_v_mv); /* proto */
...
/* "running_gradient_filter.pyx":23
 * #############################################################################
 * 
 * cdef void calc_a_b(float sum_x, float sum_y, float sum_xy, float sum_xx, int N,             # <<<<<<<<<<<<<<
 *                    float* a, float* b):
 *     cdef float mean_x = 0.0
 */

static void __pyx_f_23running_gradient_filter_calc_a_b(float __pyx_v_sum_x, float __pyx_v_sum_y, float __pyx_v_sum_xy, float __pyx_v_sum_xx, int __pyx_v_N, float *__pyx_v_a, float *__pyx_v_b) {
  float __pyx_v_mean_x;
  float __pyx_v_mean_xx;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calc_a_b", 0);

  /* "running_gradient_filter.pyx":25
 * cdef void calc_a_b(float sum_x, float sum_y, float sum_xy, float sum_xx, int N,
 *                    float* a, float* b):
 *     cdef float mean_x = 0.0             # <<<<<<<<<<<<<<
 *     cdef float mean_xx = 0.0
 *     cdef float mean_y = 0.0
 */
  __pyx_v_mean_x = 0.0;

  /* "running_gradient_filter.pyx":26
 *                    float* a, float* b):
 *     cdef float mean_x = 0.0
 *     cdef float mean_xx = 0.0             # <<<<<<<<<<<<<<
 *     cdef float mean_y = 0.0
 ...
 */
  ...
  /* "running_gradient_filter.pyx":27
 *     cdef float mean_x = 0.0
 *     cdef float mean_xx = 0.0
 *     cdef float mean_y = 0.0             # <<<<<<<<<<<<<<
 *     cdef D = 0.0
 ...
 */
  ...
  /* "running_gradient_filter.pyx":28
 *     cdef float mean_xx = 0.0
 *     cdef float mean_y = 0.0
 *     cdef D = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "running_gradient_filter.pyx":30
 *     cdef D = 0.0
 * 
 *     mean_x = sum_x / N             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_mean_x = (__pyx_v_sum_x / __pyx_v_N);

  /* "running_gradient_filter.pyx":31
 * 
 *     mean_x = sum_x / N
 *     mean_xx = mean_x*mean_x             # <<<<<<<<<<<<<<
 *     mean_y = sum_y / N
 *     D = (sum_xx - N*mean_xx)
 */
  __pyx_v_mean_xx = (__pyx_v_mean_x * __pyx_v_mean_x);

  /* "running_gradient_filter.pyx":32
 *     mean_x = sum_x / N
 *     mean_xx = mean_x*mean_x
 *     mean_y = sum_y / N             # <<<<<<<<<<<<<<
 *     D = (sum_xx - N*mean_xx)
 ...
 */
  ...
  __pyx_v_mean_y = (__pyx_v_sum_y / __pyx_v_N);

  /* "running_gradient_filter.pyx":33
 *     mean_xx = mean_x*mean_x
 *     mean_y = sum_y / N
 *     D = (sum_xx - N*mean_xx)             # <<<<<<<<<<<<<<
 * 
 *     a[0] = (mean_y*sum_xx - mean_x*sum_xy) / D
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_sum_xx - (__pyx_v_N * __pyx_v_mean_xx))); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF_SET(__pyx_v_D, __pyx_t_1);
  __pyx_t_1 = 0;

  /* "running_gradient_filter.pyx":35
 *     D = (sum_xx - N*mean_xx)
 * 
 *     a[0] = (mean_y*sum_xx - mean_x*sum_xy) / D             # <<<<<<<<<<<<<<
 *     b[0] = (sum_xy - N*mean_x*mean_y) / D
 * 
 */
  __pyx_t_1 = PyFloat_FromDouble(((__pyx_v_mean_y * __pyx_v_sum_xx) - (__pyx_v_mean_x * __pyx_v_sum_xy))); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_1, __pyx_v_D); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_3 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  (__pyx_v_a[0]) = __pyx_t_3;

  /* "running_gradient_filter.pyx":36
 * 
 *     a[0] = (mean_y*sum_xx - mean_x*sum_xy) / D
 *     b[0] = (sum_xy - N*mean_x*mean_y) / D             # <<<<<<<<<<<<<<
 * 
 * #############################################################################
 */
  __pyx_t_2 = PyFloat_FromDouble((__pyx_v_sum_xy - ((__pyx_v_N * __pyx_v_mean_x) * __pyx_v_mean_y))); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_v_D); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsFloat(__pyx_t_1); if (unlikely((__pyx_t_3 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  (__pyx_v_b[0]) = __pyx_t_3;
 ...
 */
  ...
  __Pyx_WriteUnraisable("running_gradient_filter.calc_a_b", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
...
static PyObject *__pyx_pw_23running_gradient_filter_1running_gradient_3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_23running_gradient_filter_running_gradient_3D(PyArrayObject *__pyx_v_data, int __pyx_v_period, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_23running_gradient_filter_running_gradient_3D *__pyx_optional_args) {
  float __pyx_v_mv = ((float)2e20);
  int __pyx_v_W;
  int __pyx_v_N;
  int __pyx_v_t;
  int __pyx_v_x;
  ...
  float __pyx_v_sum_x;
  float __pyx_v_sum_y;
  float __pyx_v_sum_xy;
  float __pyx_v_sum_xx;
  float __pyx_v_a;
  float __pyx_v_b;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("running_gradient_3D", 0);
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_mv = __pyx_optional_args->mv;
    }
  }
  ...
  __pyx_pybuffernd_data.rcbuffer = &__pyx_pybuffer_data;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_data, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "running_gradient_filter.pyx":42
 * cpdef numpy.ndarray[float, ndim=3] running_gradient_3D(numpy.ndarray[float, ndim=3] data,
 *                                                        int period, float mv=2e20):
 *     cdef int W = period/2           # window width             # <<<<<<<<<<<<<<
 *     cdef int N = W                  # number of samples (current)
 *     cdef int t, x, y                # indices into the array
 */
  __pyx_v_W = __Pyx_div_long(__pyx_v_period, 2);

  /* "running_gradient_filter.pyx":43
 *                                                        int period, float mv=2e20):
 *     cdef int W = period/2           # window width
 *     cdef int N = W                  # number of samples (current)             # <<<<<<<<<<<<<<
 *     cdef int t, x, y                # indices into the array
 ...
 */
  ...
  /* "running_gradient_filter.pyx":45
 *     cdef int N = W                  # number of samples (current)
 *     cdef int t, x, y                # indices into the array
 *     cdef nt = data.shape[0]         # number of t points             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_data->dimensions[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_nt = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "running_gradient_filter.pyx":46
 *     cdef int t, x, y                # indices into the array
 *     cdef nt = data.shape[0]         # number of t points
 *     cdef ny = data.shape[1]         # number of y points             # <<<<<<<<<<<<<<
 *     cdef nx = data.shape[2]         # number of x points
 *     # output array
 */
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_data->dimensions[1])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_ny = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "running_gradient_filter.pyx":47
 *     cdef nt = data.shape[0]         # number of t points
 *     cdef ny = data.shape[1]         # number of y points
 *     cdef nx = data.shape[2]         # number of x points             # <<<<<<<<<<<<<<
 *     # output array
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_data->dimensions[2])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_nx = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "running_gradient_filter.pyx":49
 *     cdef nx = data.shape[2]         # number of x points
 *     # output array
 *     cdef numpy.ndarray[float, ndim=3] out_data = numpy.zeros([nt, ny, nx], 'f')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_v_nt);
  __Pyx_GIVEREF(__pyx_v_nt);
  __Pyx_INCREF(__pyx_v_ny);
  PyList_SET_ITEM(__pyx_t_2, 1, __pyx_v_ny);
  __Pyx_GIVEREF(__pyx_v_ny);
  __Pyx_INCREF(__pyx_v_nx);
  PyList_SET_ITEM(__pyx_t_2, 2, __pyx_v_nx);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out_data.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
  ...
  /* "running_gradient_filter.pyx":52
 * 
 *     # variables for the summing of x,y, xy, x^2 and y^2
 *     cdef float sum_x  = 0.0             # <<<<<<<<<<<<<<
 *     cdef float sum_y  = 0.0
 *     cdef float sum_xy = 0.0
 */
  __pyx_v_sum_x = 0.0;

  /* "running_gradient_filter.pyx":53
 *     # variables for the summing of x,y, xy, x^2 and y^2
 *     cdef float sum_x  = 0.0
 *     cdef float sum_y  = 0.0             # <<<<<<<<<<<<<<
 *     cdef float sum_xy = 0.0
 *     cdef float sum_xx = 0.0
 */
  __pyx_v_sum_y = 0.0;

  /* "running_gradient_filter.pyx":54
 *     cdef float sum_x  = 0.0
 *     cdef float sum_y  = 0.0
 *     cdef float sum_xy = 0.0             # <<<<<<<<<<<<<<
 *     cdef float sum_xx = 0.0
 ...
 */
  ...
  /* "running_gradient_filter.pyx":55
 *     cdef float sum_y  = 0.0
 *     cdef float sum_xy = 0.0
 *     cdef float sum_xx = 0.0             # <<<<<<<<<<<<<<
 *     cdef float a, b
 ...
 */
  ...
  /* "running_gradient_filter.pyx":59
 * 
 ...
 */
  __pyx_t_8 = __Pyx_PyInt_As_long(__pyx_v_ny); if (unlikely((__pyx_t_8 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_y = __pyx_t_9;

    /* "running_gradient_filter.pyx":60
 *     # loop over the data array
 *     for y in range(0, ny):
 *         for x in range(0, nx):             # <<<<<<<<<<<<<<
 *             # skip if this box contains missing values
 *             if data[0,y,x] == mv:
 */
    __pyx_t_10 = __Pyx_PyInt_As_long(__pyx_v_nx); if (unlikely((__pyx_t_10 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_x = __pyx_t_11;

      /* "running_gradient_filter.pyx":62
 *         for x in range(0, nx):
 *             # skip if this box contains missing values
 *             if data[0,y,x] == mv:             # <<<<<<<<<<<<<<
 *                 out_data[:,y,x] = mv
 ...
 */
      ...
      __pyx_t_15 = (((*__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_data.diminfo[1].strides, __pyx_t_14, __pyx_pybuffernd_data.diminfo[2].strides)) == __pyx_v_mv) != 0);
      if (__pyx_t_15) {

        /* "running_gradient_filter.pyx":63
 *             # skip if this box contains missing values
 *             if data[0,y,x] == mv:
 *                 out_data[:,y,x] = mv             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_mv); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        ...
        __pyx_t_3 = 0;
        __pyx_t_6 = 0;
        if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_out_data), __pyx_t_2, __pyx_t_1) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

        /* "running_gradient_filter.pyx":64
 *             if data[0,y,x] == mv:
 *                 out_data[:,y,x] = mv
 *                 continue             # <<<<<<<<<<<<<<
 *             # reset sums for this grid box
 ...
 */
      ...
      /* "running_gradient_filter.pyx":66
 *                 continue
 *             # reset sums for this grid box
 *             sum_x = 0.0             # <<<<<<<<<<<<<<
 *             sum_y = 0.0
 ...
 */
      ...
      /* "running_gradient_filter.pyx":67
 *             # reset sums for this grid box
 *             sum_x = 0.0
 *             sum_y = 0.0             # <<<<<<<<<<<<<<
 *             sum_xy = 0.0
 ...
 */
      ...
      /* "running_gradient_filter.pyx":68
 *             sum_x = 0.0
 *             sum_y = 0.0
 *             sum_xy = 0.0             # <<<<<<<<<<<<<<
 *             sum_xx = 0.0
 ...
 */
      ...
      /* "running_gradient_filter.pyx":69
 *             sum_y = 0.0
 *             sum_xy = 0.0
 *             sum_xx = 0.0             # <<<<<<<<<<<<<<
 *             N = W
 ...
 */
      ...
      /* "running_gradient_filter.pyx":70
 *             sum_xy = 0.0
 *             sum_xx = 0.0
 *             N = W             # <<<<<<<<<<<<<<
 *             # create the first value by calculating the sums up to W
 ...
 */
      ...
      /* "running_gradient_filter.pyx":72
 *             N = W
 *             # create the first value by calculating the sums up to W
 *             for t in range(0, W):             # <<<<<<<<<<<<<<
 *                 sum_x  += t
 ...
 */
      ...
      for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        ...
        /* "running_gradient_filter.pyx":73
 *             # create the first value by calculating the sums up to W
 *             for t in range(0, W):
 *                 sum_x  += t             # <<<<<<<<<<<<<<
 *                 sum_y  += data[t,y,x]
 *                 sum_xy += t*data[t,y,x]
 */
        __pyx_v_sum_x = (__pyx_v_sum_x + __pyx_v_t);

        /* "running_gradient_filter.pyx":74
 *             for t in range(0, W):
 *                 sum_x  += t
 *                 sum_y  += data[t,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xy += t*data[t,y,x]
 ...
 */
        ...
        __pyx_v_sum_y = (__pyx_v_sum_y + (*__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_data.diminfo[1].strides, __pyx_t_20, __pyx_pybuffernd_data.diminfo[2].strides)));

        /* "running_gradient_filter.pyx":75
 *                 sum_x  += t
 *                 sum_y  += data[t,y,x]
 *                 sum_xy += t*data[t,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xx += t*t
 ...
 */
        ...
        __pyx_v_sum_xy = (__pyx_v_sum_xy + (__pyx_v_t * (*__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_data.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_data.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_data.diminfo[1].strides, __pyx_t_23, __pyx_pybuffernd_data.diminfo[2].strides))));

        /* "running_gradient_filter.pyx":76
 *                 sum_y  += data[t,y,x]
 *                 sum_xy += t*data[t,y,x]
 *                 sum_xx += t*t             # <<<<<<<<<<<<<<
 * 
 *             # calculate a and b
 */
        __pyx_v_sum_xx = (__pyx_v_sum_xx + (__pyx_v_t * __pyx_v_t));
      }

      /* "running_gradient_filter.pyx":79
 * 
 *             # calculate a and b
 *             calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)             # <<<<<<<<<<<<<<
 *             # do the first projection
 *             out_data[0,y,x] = a + b
 */
      __pyx_f_23running_gradient_filter_calc_a_b(__pyx_v_sum_x, __pyx_v_sum_y, __pyx_v_sum_xy, __pyx_v_sum_xx, __pyx_v_N, (&__pyx_v_a), (&__pyx_v_b));

      /* "running_gradient_filter.pyx":81
 *             calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)
 *             # do the first projection
 *             out_data[0,y,x] = a + b             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_out_data.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_out_data.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_out_data.diminfo[1].strides, __pyx_t_17, __pyx_pybuffernd_out_data.diminfo[2].strides) = (__pyx_v_a + __pyx_v_b);

      /* "running_gradient_filter.pyx":84
 * 
 *             # calculate the values between 1 and W - just add more data
 *             for t in range(0, W):             # <<<<<<<<<<<<<<
 *                 N += 1
 ...
 */
      ...
      for (__pyx_t_26 = 0; __pyx_t_26 < __pyx_t_25; __pyx_t_26+=1) {
        ...
        /* "running_gradient_filter.pyx":85
 *             # calculate the values between 1 and W - just add more data
 *             for t in range(0, W):
 *                 N += 1             # <<<<<<<<<<<<<<
 *                 T1 = t+W
 ...
 */
        ...
        /* "running_gradient_filter.pyx":86
 *             for t in range(0, W):
 *                 N += 1
 *                 T1 = t+W             # <<<<<<<<<<<<<<
 *                 sum_x  += T1
 *                 sum_y  += data[T1,y,x]
 */
        __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_t + __pyx_v_W)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 86; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_XDECREF_SET(__pyx_v_T1, __pyx_t_1);
        __pyx_t_1 = 0;

        /* "running_gradient_filter.pyx":87
 *                 N += 1
 *                 T1 = t+W
 *                 sum_x  += T1             # <<<<<<<<<<<<<<
 *                 sum_y  += data[T1,y,x]
 ...
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_sum_x); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_2 = PyNumber_InPlaceAdd(__pyx_t_1, __pyx_v_T1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_v_sum_x = __pyx_t_27;

        /* "running_gradient_filter.pyx":88
 *                 T1 = t+W
 *                 sum_x  += T1
 *                 sum_y  += data[T1,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xy += T1*data[T1,y,x]
 *                 sum_xx += T1*T1
 */
        __pyx_t_2 = PyFloat_FromDouble(__pyx_v_sum_y); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        ...
        __pyx_t_1 = 0;
        __pyx_t_6 = 0;
        __pyx_t_6 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_3); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = PyNumber_InPlaceAdd(__pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_y = __pyx_t_27;

        /* "running_gradient_filter.pyx":89
 *                 sum_x  += T1
 *                 sum_y  += data[T1,y,x]
 *                 sum_xy += T1*data[T1,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xx += T1*T1
 * 
 */
        __pyx_t_3 = PyFloat_FromDouble(__pyx_v_sum_xy); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        ...
        __pyx_t_6 = 0;
        __pyx_t_2 = 0;
        __pyx_t_2 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_1); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T1, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = PyNumber_InPlaceAdd(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_v_sum_xy = __pyx_t_27;

        /* "running_gradient_filter.pyx":90
 *                 sum_y  += data[T1,y,x]
 *                 sum_xy += T1*data[T1,y,x]
 *                 sum_xx += T1*T1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_2 = PyFloat_FromDouble(__pyx_v_sum_xx); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T1, __pyx_v_T1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = PyNumber_InPlaceAdd(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_xx = __pyx_t_27;

        /* "running_gradient_filter.pyx":93
 * 
 *                 # calculate a and b and reconstruct the value
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "running_gradient_filter.pyx":94
 *                 # calculate a and b and reconstruct the value
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)
 *                 out_data[t,y,x] = a + t*b             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_out_data.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_out_data.diminfo[0].strides, __pyx_t_29, __pyx_pybuffernd_out_data.diminfo[1].strides, __pyx_t_30, __pyx_pybuffernd_out_data.diminfo[2].strides) = (__pyx_v_a + (__pyx_v_t * __pyx_v_b));
      }

      /* "running_gradient_filter.pyx":97
 * 
 *             # calculate the values between W and nt-W - subtract the last value and add then next
 ...
 *                 T1 = t+W
 */
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_W); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_nt, __pyx_t_3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_31 = __Pyx_PyInt_As_long(__pyx_t_1); if (unlikely((__pyx_t_31 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      for (__pyx_t_25 = __pyx_v_W; __pyx_t_25 < __pyx_t_31; __pyx_t_25+=1) {
        __pyx_v_t = __pyx_t_25;

        /* "running_gradient_filter.pyx":98
 *             # calculate the values between W and nt-W - subtract the last value and add then next
 *             for t in range(W, nt-W):
 *                 T0 = t-W             # <<<<<<<<<<<<<<
 *                 T1 = t+W
 *                 sum_x  = sum_x - T0 + T1
 */
        __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_t - __pyx_v_W)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_XDECREF_SET(__pyx_v_T0, __pyx_t_1);
        __pyx_t_1 = 0;

        /* "running_gradient_filter.pyx":99
 *             for t in range(W, nt-W):
 *                 T0 = t-W
 *                 T1 = t+W             # <<<<<<<<<<<<<<
 *                 sum_x  = sum_x - T0 + T1
 ...
 */
        __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_t + __pyx_v_W)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_XDECREF_SET(__pyx_v_T1, __pyx_t_1);
        __pyx_t_1 = 0;

        /* "running_gradient_filter.pyx":100
 *                 T0 = t-W
 *                 T1 = t+W
 *                 sum_x  = sum_x - T0 + T1             # <<<<<<<<<<<<<<
 *                 sum_y  = sum_y - data[T0,y,x] + data[T1,y,x]
 ...
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_sum_x); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = PyNumber_Subtract(__pyx_t_1, __pyx_v_T0); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Add(__pyx_t_3, __pyx_v_T1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_1); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_v_sum_x = __pyx_t_27;

        /* "running_gradient_filter.pyx":101
 *                 T1 = t+W
 *                 sum_x  = sum_x - T0 + T1
 *                 sum_y  = sum_y - data[T0,y,x] + data[T1,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xy = sum_xy - T0*data[T0,y,x] + T1*data[T1,y,x]
 ...
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_sum_y); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        ...
        __pyx_t_3 = 0;
        __pyx_t_2 = 0;
        __pyx_t_2 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_6); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_6 = PyNumber_Subtract(__pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        ...
        __pyx_t_2 = 0;
        __pyx_t_1 = 0;
        __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_3); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = PyNumber_Add(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_y = __pyx_t_27;

        /* "running_gradient_filter.pyx":102
 *                 sum_x  = sum_x - T0 + T1
 *                 sum_y  = sum_y - data[T0,y,x] + data[T1,y,x]
 *                 sum_xy = sum_xy - T0*data[T0,y,x] + T1*data[T1,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xx = sum_xx - T0*T0 + T1*T1
 * 
 */
        __pyx_t_3 = PyFloat_FromDouble(__pyx_v_sum_xy); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        ...
        __pyx_t_1 = 0;
        __pyx_t_6 = 0;
        __pyx_t_6 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_2); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = PyNumber_Multiply(__pyx_v_T0, __pyx_t_6); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_6 = PyNumber_Subtract(__pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        ...
        __pyx_t_2 = 0;
        __pyx_t_3 = 0;
        __pyx_t_3 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_1); if (unlikely(__pyx_t_3 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T1, __pyx_t_3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = PyNumber_Add(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_xy = __pyx_t_27;

        /* "running_gradient_filter.pyx":103
 *                 sum_y  = sum_y - data[T0,y,x] + data[T1,y,x]
 *                 sum_xy = sum_xy - T0*data[T0,y,x] + T1*data[T1,y,x]
 *                 sum_xx = sum_xx - T0*T0 + T1*T1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_3 = PyFloat_FromDouble(__pyx_v_sum_xx); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T0, __pyx_v_T0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        ...
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T1, __pyx_v_T1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = PyNumber_Add(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_xx = __pyx_t_27;

        /* "running_gradient_filter.pyx":106
 * 
 *                 # calc a and b and reconstruct
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)             # <<<<<<<<<<<<<<
 *                 out_data[t,y,x] = a + t*b
 ...
 */
        ...
        /* "running_gradient_filter.pyx":107
 *                 # calc a and b and reconstruct
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)
 *                 out_data[t,y,x] = a + t*b             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_out_data.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_out_data.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_out_data.diminfo[1].strides, __pyx_t_33, __pyx_pybuffernd_out_data.diminfo[2].strides) = (__pyx_v_a + (__pyx_v_t * __pyx_v_b));
      }

      /* "running_gradient_filter.pyx":111
 *             # finally calculate the values between nt-W and nt - just subtract the last values
 *             # and decrement N
 ...
 *                 T0 = t-W
 */
      __pyx_t_31 = __Pyx_PyInt_As_long(__pyx_v_nt); if (unlikely((__pyx_t_31 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_W); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_nt, __pyx_t_3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_34 = __Pyx_PyInt_As_long(__pyx_t_1); if (unlikely((__pyx_t_34 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 111; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      for (__pyx_t_25 = __pyx_t_34; __pyx_t_25 < __pyx_t_31; __pyx_t_25+=1) {
        __pyx_v_t = __pyx_t_25;

        /* "running_gradient_filter.pyx":112
 *             # and decrement N
 *             for t in range(nt-W, nt):
 *                 N -= 1             # <<<<<<<<<<<<<<
 *                 T0 = t-W
 ...
 */
        ...
        /* "running_gradient_filter.pyx":113
 *             for t in range(nt-W, nt):
 *                 N -= 1
 *                 T0 = t-W             # <<<<<<<<<<<<<<
 *                 sum_x  = sum_x - T0
 ...
 */
        __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_t - __pyx_v_W)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_XDECREF_SET(__pyx_v_T0, __pyx_t_1);
        __pyx_t_1 = 0;

        /* "running_gradient_filter.pyx":114
 *                 N -= 1
 *                 T0 = t-W
 *                 sum_x  = sum_x - T0             # <<<<<<<<<<<<<<
 *                 sum_y  = sum_y - data[T0,y,x]
 ...
 */
        __pyx_t_1 = PyFloat_FromDouble(__pyx_v_sum_x); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = PyNumber_Subtract(__pyx_t_1, __pyx_v_T0); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_x = __pyx_t_27;

        /* "running_gradient_filter.pyx":115
 *                 T0 = t-W
 *                 sum_x  = sum_x - T0
 *                 sum_y  = sum_y - data[T0,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xy = sum_xy - T0*data[T0,y,x]
 *                 sum_xx = sum_xx - T0*T0
 */
        __pyx_t_3 = PyFloat_FromDouble(__pyx_v_sum_y); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        ...
        __pyx_t_1 = 0;
        __pyx_t_6 = 0;
        __pyx_t_6 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_2); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_t_2 = PyNumber_Subtract(__pyx_t_3, __pyx_t_6); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_v_sum_y = __pyx_t_27;

        /* "running_gradient_filter.pyx":116
 *                 sum_x  = sum_x - T0
 *                 sum_y  = sum_y - data[T0,y,x]
 *                 sum_xy = sum_xy - T0*data[T0,y,x]             # <<<<<<<<<<<<<<
 *                 sum_xx = sum_xx - T0*T0
 * 
 */
        __pyx_t_2 = PyFloat_FromDouble(__pyx_v_sum_xy); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        ...
        __pyx_t_6 = 0;
        __pyx_t_3 = 0;
        __pyx_t_3 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_1); if (unlikely(__pyx_t_3 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T0, __pyx_t_3); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        ...
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_v_sum_xy = __pyx_t_27;

        /* "running_gradient_filter.pyx":117
 *                 sum_y  = sum_y - data[T0,y,x]
 *                 sum_xy = sum_xy - T0*data[T0,y,x]
 *                 sum_xx = sum_xx - T0*T0             # <<<<<<<<<<<<<<
 * 
 *                 # calc a and b and reconstruct
 */
        __pyx_t_3 = PyFloat_FromDouble(__pyx_v_sum_xx); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_1 = PyNumber_Multiply(__pyx_v_T0, __pyx_v_T0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        ...
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_27 = __pyx_PyFloat_AsFloat(__pyx_t_2); if (unlikely((__pyx_t_27 == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __pyx_v_sum_xx = __pyx_t_27;

        /* "running_gradient_filter.pyx":120
 * 
 *                 # calc a and b and reconstruct
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)             # <<<<<<<<<<<<<<
 *                 out_data[t,y,x] = a + t*b
 ...
 */
        ...
        /* "running_gradient_filter.pyx":121
 *                 # calc a and b and reconstruct
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)
 *                 out_data[t,y,x] = a + t*b             # <<<<<<<<<<<<<<
 *     return out_data
 */
        ...
        *__Pyx_BufPtrStrided3d(float *, __pyx_pybuffernd_out_data.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_out_data.diminfo[0].strides, __pyx_t_36, __pyx_pybuffernd_out_data.diminfo[1].strides, __pyx_t_37, __pyx_pybuffernd_out_data.diminfo[2].strides) = (__pyx_v_a + (__pyx_v_t * __pyx_v_b));
      }
      __pyx_L5_continue:;
    }
  }

  /* "running_gradient_filter.pyx":122
 *                 calc_a_b(sum_x, sum_y, sum_xy, sum_xx, N, &a, &b)
 *                 out_data[t,y,x] = a + t*b
 *     return out_data             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_r = ((PyArrayObject *)__pyx_v_out_data);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("running_gradient_filter.running_gradient_3D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_data.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_23running_gradient_filter_1running_gradient_3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_23running_gradient_filter_1running_gradient_3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("running_gradient_3D (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_period,&__pyx_n_s_mv,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_period)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("running_gradient_3D", 0, 2, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mv);
          if (value) { values[2] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "running_gradient_3D") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_period = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_period == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[2]) {
      __pyx_v_mv = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_mv == (float)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_mv = ((float)2e20);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("running_gradient_3D", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("running_gradient_filter.running_gradient_3D", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_r = __pyx_pf_23running_gradient_filter_running_gradient_3D(__pyx_self, __pyx_v_data, __pyx_v_period, __pyx_v_mv);
...
static PyObject *__pyx_pf_23running_gradient_filter_running_gradient_3D(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_data, int __pyx_v_period, float __pyx_v_mv) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_data;
  __Pyx_Buffer __pyx_pybuffer_data;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_23running_gradient_filter_running_gradient_3D __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("running_gradient_3D", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.mv = __pyx_v_mv;
  __pyx_t_1 = ((PyObject *)__pyx_f_23running_gradient_filter_running_gradient_3D(__pyx_v_data, __pyx_v_period, 0, &__pyx_t_2)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"running_gradient_3D", (PyCFunction)__pyx_pw_23running_gradient_filter_1running_gradient_3D, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrunning_gradient_filter(void); /*proto*/
PyMODINIT_FUNC initrunning_gradient_filter(void)
#else
PyMODINIT_FUNC PyInit_running_gradient_filter(void); /*proto*/
PyMODINIT_FUNC PyInit_running_gradient_filter(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_running_gradient_filter(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("running_gradient_filter", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_running_gradient_filter) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "running_gradient_filter")) {
      if (unlikely(PyDict_SetItemString(modules, "running_gradient_filter", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "running_gradient_filter.pyx":19
 * 
 * cimport numpy
 * import numpy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init running_gradient_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init running_gradient_filter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
